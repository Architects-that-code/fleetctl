...
The following live diagrams are generated by the built-in diagram generator. They are also saved in docs/architecture.md and docs/packages.md and can be regenerated using the commands in the "Diagram Generation" section above.
